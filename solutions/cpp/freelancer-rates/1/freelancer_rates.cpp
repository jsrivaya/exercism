...
double daily_rate(double hourly_rate) {
    // DONE: Implement a function to calculate the daily rate given an hourly
    // rate
...
double apply_discount(double before_discount, double discount) {
    // DONE: Implement a function to calculate the price after a discount.
...
int monthly_rate(double hourly_rate, double discount) {
    // DONE: Implement a function to calculate the monthly rate, and apply a
    // discount.
